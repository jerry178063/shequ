...
public abstract class BaseListFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        //TLog.i(getClass().getSimpleName() + ">>>>>>>>>>>　　onCreateView");
        if (mView == null) {
            mContext = getContext();
            mView = View.inflate(mContext, getLayoutId(), null);
            initView(mView);
            //TLog.i(getClass().getSimpleName() + ">>>>>>>>>>>　　initView");
        } else {
            ...
            //TLog.i(getClass().getSimpleName() + ">>>>>>>>>>>　　removeView");
        }
        return mView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //TLog.i(getClass().getSimpleName() + ">>>>>>>>>>>　　onActivityCreated");
    ...
    public void onDestroyView() {
        super.onDestroyView();
        //TLog.i(getClass().getSimpleName() + ">>>>>>>>>>>　　onDestroyView");
    }
