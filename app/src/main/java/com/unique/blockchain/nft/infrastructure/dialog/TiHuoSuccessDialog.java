 ...
 *
 * */
public class TiHuoSuccessDialog extends Dialog implements View.OnClickListener {


    private Context mContext;
    private OnBackZhujiClickView onClickView;
    public TextView tv_cancel;
    public TiHuoSuccessDialog(@NonNull @NotNull Context context) {
        this(context, R.style.customor_service);
        this.mContext = context;
    }

    public TiHuoSuccessDialog(@NonNull @NotNull Context context, int themeResId) {
