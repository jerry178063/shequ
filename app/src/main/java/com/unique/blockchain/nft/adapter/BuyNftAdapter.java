 ...
 * 销售我的NFT
 */
public class BuyNftAdapter extends BaseQuickAdapter<MarkHotBean.Rows, BaseViewHolder> {
    ...
    public BuyNftAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<MarkHotBean.Rows> data, Context context, String uniqueAdress) {
