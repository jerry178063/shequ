...
import com.unique.blockchain.nft.infrastructure.dialog.AddSuccessDialog;
 ...
 * 添加新资产
 */
public class AddDigitalAssetsActivity extends BaseActivity implements AddDigitalDialog.OnSafeClickView,AddSuccessDialog.OnBackZhujiClickView {
    ...
    protected int getLayoutId() {
        return R.layout.activity_add_digital;
    }
...
//                Intent intent1 = new Intent(AddDigitalAssetsActivity.this, DigitalHomeAssetsActivity.class);
...
//        });
        voteAreaAdapter.setOnItemSelectedWallet(new AddNewDigitalListAdapter.LinSelectWalletListener() {
            ...
            public void selectedWallet(String name) {
                ...
                if (addDigitalDialog == null) {
                    addDigitalDialog = new AddDigitalDialog(AddDigitalAssetsActivity.this);
                    addDigitalDialog.setOnclick(AddDigitalAssetsActivity.this);
    ...
    @OnClick({R.id.img_back, R.id.liu_souyy})
...
//                    ToastUtil.showShort(AddDigitalAssetsActivity.this,"请输入主币资产名称");
//                    return;
//                }
...
//                break;
            case R.id.liu_souyy:
                startActivity(new Intent(AddDigitalAssetsActivity.this,SearchAddDigitalAssetsActivity.class));
                break;
        }
    }
...
//                    voteAreaAdapter.setNewData(mObjectList);
        ...
        OkGo.get(UrlConstant.baseUrl + "chainConfig/list")
                ...
                .execute(new JsonCallback<ChainConfigBean>() {
                    @Override
                    public void onSuccess(ChainConfigBean jsonObject, okhttp3.Call call, okhttp3.Response response) {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(@NonNull @NotNull Message msg) {
            ...
            if(!nftUnique.isCunZai(mName).equals("不存在")) {
                ...
                hdWallet = new HDWallet(SpUtil.getInstance(AddDigitalAssetsActivity.this).getString("content") + "", "");
                unique = userDao.queryBuilder().where(UserDao.Properties.Name.eq(SPUtils.getString(AddDigitalAssetsActivity.this, Tools.name, ""))).build().unique();
                ...
                try {
                    ...
                    Log.e("FF543", "更新成功:" + SPUtils.getString(AddDigitalAssetsActivity.this, Tools.name, ""));
                    if (addSuccessDialog == null) {
                        addSuccessDialog = new AddSuccessDialog(AddDigitalAssetsActivity.this);
                        addSuccessDialog.setOnclick(AddDigitalAssetsActivity.this);
                        addSuccessDialog.show();
                    }else {
                        addSuccessDialog.show();
                    }
                    handlerAdd.sendEmptyMessage(3333);
                } catch (Exception e) {
                    Log.e("FF543", "NAME:" + SPUtils.getString(AddDigitalAssetsActivity.this, Tools.name, ""));
                }
            }else {
                ToastUtil.showShort(AddDigitalAssetsActivity.this,"已存在!");
        ...
        if (mObjectList != null) {
            ...
            if(!TextUtils.isEmpty(mName)) {
                ...
                if(name != null && name.size() > 0){
                    ToastUtil.showShort(AddDigitalAssetsActivity.this, "资产已经存在!");
                }else {//不存在可以添加
