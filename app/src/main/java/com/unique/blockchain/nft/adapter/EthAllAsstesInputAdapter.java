...
public class EthAllAsstesInputAdapter extends BaseQuickAdapter<TransactionRecordEthBean.Result.Records, BaseViewHolder> {
    private String walletAddress;
    List<TransactionRecordEthBean.Result.Records> data;
    public EthAllAsstesInputAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<TransactionRecordEthBean.Result.Records> data) {
...
//         if(!item.getAmount().contains("-")) {//转入
            tv_event.setText("转入");
            tv_num.setText( "+" + item.getAmount() + " ETH");
