 ...
 * 交易中
 * */
public class TradingFragment extends BaseFragment implements IMeMyNftAllCallBack {
    static {
    ...
    protected void initData() {
        ...
        iMeMyNftAllPresenter.getData(page,10,"1",uniqueAdress);
    }
    ...
    public void initView() {
        ...
        rows = new ArrayList<>();
        tradingAdapter = new TradingAdapter(R.layout.trading_item,rows);
        all_rec2.setAdapter(tradingAdapter);

        tradingAdapter.setOutPriceListener(new CommAdapter.OutPrice() {
            @Override
        ...
        //撤销交易
        tradingAdapter.setCancelTrade(new TradingAdapter.CancelTrade() {
            @Override
            public void CancelTrade(int position, MarkHotBean.Rows item) {
                ...
                intent.putExtra("sellMode",item.getSellMode() + "");
    ...
    public void loadMyNftAllData(MarkHotBean quanDatabase) {
        ...
        tradingAdapter.setNewData(rows);
    }
