 ...
 * 我的-交易中
 */
public class NftZichanSouAdapter extends BaseQuickAdapter<MarkHotBean.Rows, BaseViewHolder> {
    ...
    public NftZichanSouAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<MarkHotBean.Rows> data, Context context, String uniqueAdress) {
...
//        TextView tv_product = helper.getView(R.id.tv_product);//已提货简介
        ...
        tv_name_lianshang.setText(item.getNftName());
