...
import com.unique.blockchain.nft.adapter.ReceiptedAdapter;
 ...
 * 已收货
 * */
public class ReceiptedFragment extends BaseFragment implements IMeMyNftAllCallBack {
    static {
    ...
    private ReceiptedAdapter receiptedAdapter;
    ...
    protected void initData() {
        ...
        iMeMyNftAllPresenter.getData(page,10,"3",uniqueAdress);
    }
    ...
    public void initView() {
        ...
        rows = new ArrayList<>();
        receiptedAdapter = new ReceiptedAdapter(R.layout.received_item,rows);
        all_rec2.setAdapter(receiptedAdapter);

        receiptedAdapter.setOutPriceListener(new CommAdapter.OutPrice() {
            @Override
        ...
        swipeRefresh.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull @NotNull RefreshLayout refreshLayout) {
                page = 1;
                iMeMyNftAllPresenter.getData(page,10,"3",uniqueAdress);
                receiptedAdapter.cancelAllTimers();
            }
        });
    ...
    public void loadMyNftAllData(MarkHotBean quanDatabase) {
        if(quanDatabase != null && quanDatabase.getCode() == 200){
            ...
            if (page == 1) {//首页
                if(quanDatabase.getRows() != null && quanDatabase.getRows().size() > 0) {
                    ...
                    receiptedAdapter.notifyDataSetChanged();
        ...
        receiptedAdapter.setNewData(rows);
    }
