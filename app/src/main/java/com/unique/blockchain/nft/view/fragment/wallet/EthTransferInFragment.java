...
import com.unique.blockchain.nft.adapter.EthAllAsstesInputAdapter;
 ...
 * eth-转入
 * */
public class EthTransferInFragment extends BaseFragment {
    ...
    private EthAllAsstesInputAdapter allAsstesAdapter=new EthAllAsstesInputAdapter(R.layout.all_assets_item,new ArrayList<>());
    private List<TransactionRecordEthBean.Result.Records> list=new ArrayList();
    private List<TransactionRecordEthBean.Result.Records>  list2=new ArrayList();
    User unique;
