 ...
 * 我的-交易中
 */
public class AllMyTradeAdapter extends BaseQuickAdapter<MarkHotBean.Rows, BaseViewHolder> {
    private String type = "";
    ...
    public AllMyTradeAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<MarkHotBean.Rows> data, String uniqueAdress) {
