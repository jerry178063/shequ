 ...
 * 同链转账
 * */
public class KuaLianTrasnferFragment extends BaseFragment implements  SafeAdminDialog.OnSafeClickView,TransferSuccessDialog.OnBackZhujiClickView{
    ...
    protected int getLayoutId() {
        return R.layout.fragment_kualian_transfer;
    }
...
//                                    handler.sendEmptyMessage(123);
                                    if (transferSuccessDialog == null) {
                                        ...
                                        transferSuccessDialog.setOnclick(KuaLianTrasnferFragment.this);
