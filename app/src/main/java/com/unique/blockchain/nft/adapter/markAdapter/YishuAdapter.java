...
public class YishuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private List<YishuDatabase.RowsBean>list=new ArrayList<>();
    private int getType=0;
    private String type="";
    public YishuAdapter(Context context) {
        this.context = context;
    }

    public void setList(List<YishuDatabase.RowsBean> list) {
        this.list = list;
