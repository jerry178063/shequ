 ...
 *
 * */
public class ShuzhiRegisterSuccessDialog extends Dialog implements View.OnClickListener {


    private Context mContext;
    private OnBackZhujiClickView onClickView;
    public TextView tv_cancel;
    public ShuzhiRegisterSuccessDialog(@NonNull @NotNull Context context) {
        this(context, R.style.customor_service);
        this.mContext = context;
    }

    public ShuzhiRegisterSuccessDialog(@NonNull @NotNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.shuzi_register_dialog_layout, null);
