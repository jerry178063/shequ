 ...
 *
 * */
public class TransferSuccessDialog extends Dialog implements View.OnClickListener {


    private Context mContext;
    private OnBackZhujiClickView onClickView;
    public TextView tv_cancel,tv_zhuanzcg;
    public TransferSuccessDialog(@NonNull @NotNull Context context) {
        this(context, R.style.customor_service);
        this.mContext = context;
    }

    public TransferSuccessDialog(@NonNull @NotNull Context context, int themeResId) {
