 ...
 * 市场-浏览-艺术adapter
 * */
public class MarkYishuAdapter extends BaseQuickAdapter<QuanDatabase.RowsBean, BaseViewHolder> {
    private String type = "";
    ...
    public MarkYishuAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<QuanDatabase.RowsBean> data) {
