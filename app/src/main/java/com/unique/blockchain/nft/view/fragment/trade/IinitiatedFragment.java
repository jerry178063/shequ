...
import com.unique.blockchain.nft.adapter.SponsorLinitateAreaAdapter;
import com.unique.blockchain.nft.adapter.VoteLinitateAreaAdapter;
 ...
 * 我发起的
 * */
public class IinitiatedFragment extends BaseFragment {
    ...
    private SponsorLinitateAreaAdapter sponsorAreaAdapter=new SponsorLinitateAreaAdapter(R.layout.sponsor_area_item,new ArrayList<>());
    private VoteLinitateAreaAdapter voteAreaAdapter=new VoteLinitateAreaAdapter(R.layout.vote_area_item,new ArrayList<>());
