...
import com.unique.blockchain.nft.adapter.EthAllAsstesOutAdapter;
...
public class EthTransferOutFragment extends BaseFragment {
    ...
    private EthAllAsstesOutAdapter allAsstesAdapter=new EthAllAsstesOutAdapter(R.layout.all_out_assets_item,new ArrayList<>());
