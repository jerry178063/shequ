...
public class EthAllAsstesFailAdapter extends BaseQuickAdapter<TransactionRecordNewBean.Result.Records, BaseViewHolder> {
    private String walletAddress;
    List<TransactionRecordNewBean.Result.Records> data;
    public EthAllAsstesFailAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<TransactionRecordNewBean.Result.Records> data) {
