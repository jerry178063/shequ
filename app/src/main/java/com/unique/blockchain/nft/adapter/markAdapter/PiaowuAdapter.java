...
public class PiaowuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private List<PiaowuDatabase.RowsBean>list=new ArrayList<>();
    private int getType=0;
    private String type="";
    public PiaowuAdapter(Context context) {
        this.context = context;
    }

    public void setList(List<PiaowuDatabase.RowsBean> list) {
        this.list = list;
