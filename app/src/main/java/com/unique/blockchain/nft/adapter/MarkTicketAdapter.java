 ...
 * 市场-浏览-票务adapter
 * */
public class MarkTicketAdapter extends BaseQuickAdapter<QuanDatabase.RowsBean, BaseViewHolder> {
    ...
    public MarkTicketAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<QuanDatabase.RowsBean> data) {
    ...
    protected void convert(BaseViewHolder helper, QuanDatabase.RowsBean item) {
        ...
        Log.e("FF34434","票务:" + item.getSellMode());
        Log.e("FF34434","票务nftId:" + item.getNftId());
        if (item.getSellMode() == 1) {//购买
