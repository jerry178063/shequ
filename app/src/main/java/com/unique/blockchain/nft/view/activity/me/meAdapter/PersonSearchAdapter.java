...
public class PersonSearchAdapter extends RecyclerView.Adapter<PersonSearchAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public PersonSearchAdapter(Context context, List<String>histotyList){
