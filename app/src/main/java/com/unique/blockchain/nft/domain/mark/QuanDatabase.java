...
public class QuanDatabase extends BaseBean {
    ...
    public static class RowsBean {
        ...
        private boolean chooseCollect;

        public boolean isChooseCollect() {
            return chooseCollect;
        }

        public void setChooseCollect(boolean chooseCollect) {
            this.chooseCollect = chooseCollect;
        }
