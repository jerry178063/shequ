 ...
 *
 * */
public class AddDigitalDialog extends Dialog implements View.OnClickListener {
...
//    private ItemClickView itemClickView;
    private int tag;
    public AddDigitalDialog(@NonNull @NotNull Context context) {
        this(context, R.style.customor_service);
        this.mContext = context;
    }

    public AddDigitalDialog(@NonNull @NotNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.add_digital_dialog_layout, null);
