...
public class SlideNewRecyclerView extends RecyclerView {
    ...
    public SlideNewRecyclerView(Context context) {
        this(context, null);
    }

    public SlideNewRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideNewRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
