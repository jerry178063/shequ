...
/**
 * 转出*/
public class EthAllAsstesOutAdapter extends BaseQuickAdapter<TransactionRecordEthBean.Result.Records, BaseViewHolder> {
    private String walletAddress;
    List<TransactionRecordEthBean.Result.Records> data;
    public EthAllAsstesOutAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<TransactionRecordEthBean.Result.Records> data) {
