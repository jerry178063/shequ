...
public class EthAllAsstesAdapter extends BaseQuickAdapter<TransactionRecordEthBean.Result.Records, BaseViewHolder> {
    private String walletAddress;
    List<TransactionRecordEthBean.Result.Records> data;
    public EthAllAsstesAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<TransactionRecordEthBean.Result.Records> data) {
