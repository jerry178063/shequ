 ...
 *
 * */
public class AddtionalAssetsYongDialog extends Dialog implements View.OnClickListener {
    ...
    public AddtionalAssetsYongDialog(@NonNull @NotNull Context context) {
        this(context, R.style.customor_service);
        this.mContext = context;
    }

    public AddtionalAssetsYongDialog(@NonNull @NotNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.addtionl_dialog_yong_layout, null);
