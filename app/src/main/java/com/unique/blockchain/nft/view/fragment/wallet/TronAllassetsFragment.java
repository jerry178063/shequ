...
import com.unique.blockchain.nft.adapter.TronAllAsstesAdapter;
...
public class TronAllassetsFragment extends BaseFragment {
    ...
    private TronAllAsstesAdapter allAsstesAdapter = new TronAllAsstesAdapter(R.layout.all_assets_item, new ArrayList<>());
