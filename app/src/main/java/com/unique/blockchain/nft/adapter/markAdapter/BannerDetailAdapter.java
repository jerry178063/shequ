...
import com.unique.blockchain.nft.widget.BubbleSeekBar;
import com.unique.blockchain.nft.widget.FullScreenVideoView;
...
public class BannerDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnBannerListener {
    ...
    public BannerDetailAdapter(List<BannerDatabase.DataBean> list, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View butt_rec = LayoutInflater.from(context).inflate(R.layout.mark_detail_img, null, false);
...
//                showWait(false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(@NonNull View itemView) {
            ...
            butt_Banner = itemView.findViewById(R.id.butt_Banner_detail);
