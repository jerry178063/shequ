 ...
 * 市场-浏览-轻奢品adapter
 * */
public class MarkQingSheAdapter extends BaseQuickAdapter<QuanDatabase.RowsBean, BaseViewHolder> {
    ...
    public MarkQingSheAdapter(int layoutResId, @Nullable @org.jetbrains.annotations.Nullable List<QuanDatabase.RowsBean> data) {
