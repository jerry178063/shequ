...
//    TextView tv_content;
    ...
    public void initData() {
        ...
        SpUtil.getInstance(WalletSuccessActivity.this).putString("did",did);
        SpUtil.getInstance(WalletSuccessActivity.this).putString("name",name);
        SpUtil.getInstance(WalletSuccessActivity.this).putString("type",type);
        SpUtil.getInstance(WalletSuccessActivity.this).putString("psd",psd);
        SpUtil.getInstance(WalletSuccessActivity.this).putString("content",content);
        ...
        tv_nest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.e("fff8877","hasOnclick:" + hasOnclick);

                        Log.e("fff8877","hasOnclick2:" + hasOnclick);
                        //判断是否有网络
                        if (!PhoneUtils.isNetworkConnected(WalletSuccessActivity.this)) {
                            ToastaUtils toastaUtils = new ToastaUtils(WalletSuccessActivity.this, getResources().getString(R.string.the_network_is_not_open));
                            toastaUtils.show();
                        } else {
    ...
    private void initMainActivity() {
        Intent intent = new Intent(WalletSuccessActivity.this, MainActivity.class);
        startActivity(intent);
        SpUtil.getInstance(WalletSuccessActivity.this).putString("isFirst", "no");
...
//        list.add(new UserInfoItem("FEC", "m/44\'/3\'/0\'/0/0", 3, getResources().getResourceEntryName(R.drawable.logo_wallte_fec)));
        ...
        if(aa == 0) {
            ...
            SPUtils.putString(WalletSuccessActivity.this, Tools.name, name);
            SPUtils.putString(WalletSuccessActivity.this, "witch_wallet", name);
            aa = 1;
        }
    }
    ...
    private void postData(String gaussAdress_, String did) {
        ...
        addWalletBean.setDeviceId(AndroidGetId.getAndroidId(WalletSuccessActivity.this));
