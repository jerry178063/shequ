...
public class AllassetsFragment extends BaseFragment {
    ...
    private AllAsstesAdapter allAsstesAdapter = new AllAsstesAdapter(R.layout.all_assets_item, new ArrayList<>());
