...
import com.unique.blockchain.nft.adapter.WaitTradeAdapter;
 ...
 * 待交易
 * */
public class WaitTradeFragment extends BaseFragment implements IMeMyNftAllCallBack {
    static {
    ...
    private WaitTradeAdapter waitTradeAdapter;
    ...
    protected void initData() {
        ...
        iMeMyNftAllPresenter.getData(page,10,"0",uniqueAdress);
    }
    ...
    public void initView() {
        ...
        rows = new ArrayList<>();
        waitTradeAdapter = new WaitTradeAdapter(R.layout.wait_trade_item,rows,uniqueAdress);
        all_rec2.setAdapter(waitTradeAdapter);

        waitTradeAdapter.setOutPriceListener(new CommAdapter.OutPrice() {
            @Override
        ...
        swipeRefresh.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull @NotNull RefreshLayout refreshLayout) {
                page = 1;
                iMeMyNftAllPresenter.getData(page,10,"0",uniqueAdress);
                waitTradeAdapter.cancelAllTimers();
            }
        });
        ...
        //转移
        waitTradeAdapter.setTransfer(new AllMyTradeAdapter.Transfer() {
            @Override
        ...
        //去交易
        waitTradeAdapter.setGoTransfer(new AllMyTradeAdapter.GoTransfer() {
            @Override
        ...
        //提货
        waitTradeAdapter.setTiHuo(new AllMyTradeAdapter.TiHuo() {
            @Override
    ...
    public void loadMyNftAllData(MarkHotBean quanDatabase) {
        if(quanDatabase != null && quanDatabase.getCode() == 200){
            ...
            if (page == 1) {//首页
                if(quanDatabase.getRows() != null && quanDatabase.getRows().size() > 0) {
                    ...
                    waitTradeAdapter.notifyDataSetChanged();
        ...
        waitTradeAdapter.setNewData(rows);
    }
